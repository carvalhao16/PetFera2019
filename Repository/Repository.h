...
private :
    ...
    int rc;
    char *sql;
    static animal_obj animal;
    list<animal_obj> animais_list;
    static list <Funcionario*> funcionarios;
public:
    static list<animal_obj> animais;
static int callback(void *NotUsed, int argc, char **argv, char **azColName);
static int callbackAnimal(void *NotUsed, int argc, char **argv, char **azColName);
...
void select_init_animal();
void select_table_animal_id(string id);
void select_table_funcionario();
void select_table_funcionario_id(string id);
void pushBackAnimal(void *NotUsed, int argc, char **argv, char **azColName);
static int pushBackFuncionario();
void setAnimal(animal_obj);
list<animal_obj*> insertAnimal();
list<Funcionario*> insertFuncioanrio();
// void update_table_animal();
// void update_table_funcionario();
static list<animal_obj> getAnimais();
